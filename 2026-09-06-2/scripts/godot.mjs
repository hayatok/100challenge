...
const modes={import:['--editor','--import','--quit'],test:['--script','res://tests/run.gd'],anatomy:['--script','res://tests/anatomy.gd'],ecology:['--script','res://tests/ecology.gd'],ui:['--script','res://tests/ui.gd','--','--qa=family'],build:['--export-release','Web'],debug:['--export-debug','Web'],mac:['--export-release','macOS']};
if(command==='editor'||command==='play'){
 ...
 console.log(['test','ui','anatomy','ecology'].includes(command)?output:`Godot 4.7.2: ${command} passed`);
