...
if(command==='editor'){
 ...
 if(['test','onboarding','balance','ui','circulation','stories','city','campaign','flow','storage','storycampaign'].includes(command)){if(command!=='balance')process.stdout.write(output);}
