...
const modes={autosave:['--script','res://tests/autosave.gd'],life:['--script','res://tests/life.gd'],onboarding:['--script','res://tests/onboarding.gd'],import:['--editor','--import','--quit'],test:['--script','res://tests/run.gd'],ui:['--script','res://tests/ui.gd'],storage:['--script','res://tests/storage.gd'],flow:['--script','res://tests/shopping_flow.gd'],campaign:['--script','res://tests/campaign.gd'],city:['--script','res://tests/city.gd'],stories:['--script','res://tests/stories.gd'],storycampaign:['--script','res://tests/story_campaign.gd'],circulation:['--script','res://tests/circulation.gd'],balance:['--script','res://tests/balance.gd'],build:['--export-release','Web'],debug:['--export-debug','Web'],mac:['--export-release','macOS']};
if(command==='editor'){
 ...
 if(['test','autosave','life','onboarding','balance','ui','circulation','stories','city','campaign','flow','storage','storycampaign'].includes(command)){if(command!=='balance')process.stdout.write(output);}
