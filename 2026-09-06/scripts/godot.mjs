...
const modes={import:['--editor','--import','--quit'],test:['--script','res://tests/run.gd'],ui:['--script','res://tests/ui.gd'],city:['--script','res://tests/city.gd'],stories:['--script','res://tests/stories.gd'],circulation:['--script','res://tests/circulation.gd'],balance:['--script','res://tests/balance.gd'],build:['--export-release','Web'],debug:['--export-debug','Web'],mac:['--export-release','macOS']};
if(command==='editor'){
 ...
 if(['test','balance','ui','circulation','stories','city'].includes(command))process.stdout.write(output);
