...
const names=['web_nothreads_debug.zip','web_nothreads_release.zip','version.txt'];
...
console.log('Godot 4.7.2 Web templates ready. On macOS, install the official Godot 4.7.2 app separately if missing.');
